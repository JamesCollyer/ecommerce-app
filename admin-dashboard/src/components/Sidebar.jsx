    ...
    <div className={`bg-[#1C1C1C] flex min-h-screen md:flex ${open ? 'w-[24vw]' : 'w-[5vw]'} text-white duration-1000`}>
      ...
      {open ? (
            <div className='w-full m-5 mx-12'>
              ...
              <div>
                ...
                <ul>
                  <li onClick={() => window.open('https://github.com/JamesCollyer')} className='flex flex-row py-1 px-2 rounded-lg duration-500 items-center cursor-pointer hover:bg-[#2e2e2ee1]'>
                    <div>
                      <AiFillGithub size={27}/>
                    </div>
                    <p className='ml-3 font-semibold'>GitHub</p>
                  </li>
                  <li onClick={() => window.open('https://www.linkedin.com/in/james-collyer-24a351236/')} className='flex flex-row py-1 px-2 rounded-lg duration-500 items-center cursor-pointer hover:bg-[#2e2e2ee1]'>
                    <div>
                      <AiFillLinkedin size={27}/>
                    </div>
                    <p className='ml-3 font-semibold'>LinkedIn</p>
                  </li>
                  <li onClick={() => window.open('mailto:collyerfj@gmail.com')} className='flex flex-row py-1 px-2 rounded-lg duration-500 items-center cursor-pointer hover:bg-[#2e2e2ee1]'>
                    <div>
                      <MdEmail size={27}/>
                    </div>
      ...
      // ##################
        ...
        <div>
          ...
          <ul>
            <li onClick={() => window.open('https://github.com/JamesCollyer')} className='w-fit mx-auto flex flex-row py-1 px-2 rounded-lg duration-500 items-center cursor-pointer hover:bg-[#2e2e2ee1]'>
              <div>
                <AiFillGithub size={27}/>
              </div>
            </li>
            <li onClick={() => window.open('https://www.linkedin.com/in/james-collyer-24a351236/')} className='w-fit mx-auto flex flex-row py-1 px-2 rounded-lg duration-500 items-center cursor-pointer hover:bg-[#2e2e2ee1]'>
              <div>
                <AiFillLinkedin size={27}/>
              </div>
            </li>
            <li onClick={() => window.open('mailto:collyerfj@gmail.com')} className='w-fit mx-auto flex flex-row py-1 px-2 rounded-lg duration-500 items-center cursor-pointer hover:bg-[#2e2e2ee1]'>
              <div>
                <MdEmail size={27}/>
              </div>
            </li>
